                                    ...
                                    <div
                                        ...
                                        <div class="email-fixed-search flex-grow-1">
                                            ...
                                            <div class="form-group position-relative  mb-0 has-icon-left">
                                                <input type="text" class="form-control" placeholder="Search pesan..">
                                        ...
                                        <span class="d-none d-sm-block">1-10 of 10
                                        </span>
                                    ...
                                    <ul class="users-list-wrapper media-list">
                                            ...
                                            <div class="media-body">
                                                <div class="user-details">
                                                    <div class="mail-items">
                                                        <span class="list-group-item-text text-truncate">Member 1</span>
                                                    </div>
                                        ...
                                        <li class="media mail-read">
                                            ...
                                            <div class="media-body">
                                                <div class="user-details">
                                                    <div class="mail-items">
                                                        <span class="list-group-item-text text-truncate">Member 2</span>
                                                    </div>
                                                    <div class="mail-meta-item">
                                                        <span class="float-right">
                                        ...
                                        <li class="media">
                                            ...
                                            <div class="media-body">
                                                <div class="user-details">
                                                    <div class="mail-items">
                                                        <span class="list-group-item-text text-truncate">Member 3</span>
                                                    </div>
                                                    <div class="mail-meta-item">
                                                        <span class="float-right">
                                                            <span class="mail-date">2:15 AM</span>
                                                ...
                                                <div class="mail-message">
                                                    <p class="list-group-item-text mb-0 truncate">
                                                        Sekedar mengingatkan untuk waktunya obat rutin
                                                    </p>
                                                    <div class="mail-meta-item">
                                        ...
                                        <li class="media">
                                            ...
                                            <div class="media-body">
                                                <div class="user-details">
                                                    <div class="mail-items">
                                                        <span class="list-group-item-text text-truncate">Member 4</span>
                                                    </div>
                                                    <div class="mail-meta-item">
                                                        <span class="float-right">
                                        ...
                                        <li class="media mail-read">
                                            ...
                                            <div class="media-body">
                                                <div class="user-details">
                                                    <div class="mail-items">
                                                        <span class="list-group-item-text text-truncate mb-0">Member 5</span>
                                                    </div>
                                                    <div class="mail-meta-item">
                                                        <span class="float-right">
                                                ...
                                                <div class="mail-message">
                                                    <p class="list-group-item-text mb-0 truncate">
                                                        Terima Kasih, Silahkan pesan kembali...
                                                    </p>
                                                    <div class="mail-meta-item">
                                                        <span class="float-right d-flex align-items-center">
                                                            <i class="bi bi-paperclip me-3"></i>
                            ...
                            <div class="email-detail-header">
                                ...
                                <div class="email-header-right mb-1 ml-2 pl-1">
                                    <ul class="list-inline m-0">
                                        ...
                                        <li class="list-inline-item">
                                            <span class="no-of-list d-none d-sm-block ms-1">1-10 of 15</span>
                                        </li>
                                        <li class="list-inline-item">

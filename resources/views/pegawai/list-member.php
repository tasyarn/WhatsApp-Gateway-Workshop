...
<head>
    ...
    <title>Data Master - Data Pasien</title>
                        ...
                        <li class="sidebar-item active has-sub">
                            ...
                            <ul class="submenu active">
                                <li class="submenu-item active">
                                    <a href="datamaster-datapasien.html">Pengelolaan Pegawai</a>
                                </li>
                            </a>
                            <ul class="submenu active">
                                <li class="submenu-item active ">
                                    <a href="datamaster-dataobat.html">Pasien/Member</a>
                                </li>
                            </a>
                            <ul class="submenu active">
                                <li class="submenu-item active">
                                    <a href="datamaster-dataobat.html">List Member</a>
                                <li class="submenu-item ">
                                    <a href="datamaster-dataobat.html">Menambah Member</a>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex flex-row-reverse mb-4">
                                        <a href="tambah-member.html" class="btn btn-sm btn-primary">+ Tambah Member</a>
                                    </div>
